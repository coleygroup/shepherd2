...
from shepherd.model.equiformer_v3.models.equiformer_v3.radial_function import GaussianSmearing
from shepherd.model.equiformer_v3.models.equiformer_v3.so3 import SO3Grid, SO3Rotation
from shepherd.model.equiformer_v3.models.equiformer_v3.transformer_block import TransBlockV3
...
_lmax       = 2
_mmax       = 2
_attn_grid_resolution_list = [6,  6]
_ffn_grid_resolution_list  = [6, 6]
_num_channels = 128
_num_atom_types = 128
_num_basis = 8
...
def test_transformer_blocks():
    ...
    block = TransBlockV3(
        input_sphere_channels=_num_channels, # added for ShEPhERDv2 compatibility
        ...
        # max_num_elements=_num_atom_types, # removed since we use linear instead of embedding
    ...
    #print(block)
    block = torch.compile(block, dynamic=True)
